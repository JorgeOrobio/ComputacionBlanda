...
ax1.plot(x_servicio,servicio_alto,'r',linewidth=1.5,label='Bueno')
ax1.set_title('calidad del servicio')
ax1.legend()
plt.show()

ax2.plot(x_propina,calidad_baja,'b',linewidth=1.5,label='Bajo')
ax2.plot(x_propina,calidad_media,'g',linewidth=1.5,label='Medio')
ax2.plot(x_propina,calidad_alta,'r',linewidth=1.5,label='Alto')
ax2.set_title('Valor de la propina')
ax2.legend()

for ax in (ax0,ax1,ax2):
    ax.snipes['top'].set_visible(False)
    ax.snipes['right'].set_visible(False)
...
ax0.plot(x_propina,propina_media,'b',linewidth=0.5, linestyle='--',)
...
ax0.set_title('Actividad de memebresía de salida')
